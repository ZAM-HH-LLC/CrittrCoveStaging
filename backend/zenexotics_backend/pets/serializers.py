...
class PetDetailSerializer(PetSerializer):
    ...
    spayedNeutered = serializers.BooleanField(source='spayed_neutered', required=False)
    houseTrained = serializers.BooleanField(source='house_trained', required=False)
