...
class ServiceAdmin(admin.ModelAdmin):
    list_display = ('service_id', 'professional', 'service_name', 'get_primary_animal_type', 'base_rate', 'formatted_holiday_rate', 'moderation_status', 'is_active', 'is_archived', 'searchable', 'is_overnight')
    list_filter = ('moderation_status', 'is_active', 'is_archived', 'searchable', 'created_at', 'is_overnight', 'holiday_rate_is_percent')
    ...
    fieldsets = (
        ...
        ('Moderation', {
            'fields': ('moderation_status', 'moderation_notes', 'is_active', 'is_archived', 'searchable')
        }),
        ('Timestamps', {
