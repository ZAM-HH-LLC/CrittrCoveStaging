...
class ServiceAdmin(admin.ModelAdmin):
    list_display = ('service_id', 'professional', 'service_name', 'animal_type', 'base_rate', 'formatted_holiday_rate', 'moderation_status', 'searchable', 'is_overnight')
    list_filter = ('animal_type', 'moderation_status', 'searchable', 'created_at', 'is_overnight', 'holiday_rate_is_percent')
